...
public class MergrContact  extends Baseclass{
	@Test(priority = 5, groups = "Smoke", dependsOnMethods = "week2.day1assignments.CreateLead.runCreateLead")
	public  void runMergrLead() throws InterruptedException {
