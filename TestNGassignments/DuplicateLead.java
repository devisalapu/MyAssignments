...
public class DuplicateLead extends Baseclass {
	@Test(priority = 4, groups = "Smoke", dependsOnMethods = "week2.day1assignments.CreateLead.runCreateLead")
	public  void runDuplicateLead() throws InterruptedException {
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Test Company Name New");	
		driver.findElement(By.id("createLeadForm_firstName")).clear();	
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Test First Name New");	
